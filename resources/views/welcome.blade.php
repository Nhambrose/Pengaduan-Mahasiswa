...
<body class="leading-normal tracking-normal bg-blue-200" style="font-family: 'Montserrat', sans-serif">

  <nav class="flex items-center justify-between flex-wrap bg-blue-210 p-7 px-20">
    ...
    <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
      ...
      <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left text-gray-800">
        <h1 class="my-4 text-4xl font-bold leading-tight">
          Layanan Pengaduan Mahasiswa Online
        </h1>
  ...
  <!-- Footer -->
  <footer 
    class="text-center font-medium bg-blue-210 py-5">
  </footer>
