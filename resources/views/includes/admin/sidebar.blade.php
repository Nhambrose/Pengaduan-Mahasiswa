...
<aside id="warna" class="z-20 hidden w-64 overflow-y-auto bg-blue-210 dark:bg-blue-210 md:block flex-shrink-0 shadow-md">
  <div class="py-4 text-gray-500 dark:text-gray-400">
    <img src="{{ asset('img/logo.svg')}}" widht="50" high="50" alt=""
      class="inline-flex items-center transform transition hover:scale-125 duration-300 ease-in-out" />
    ...
    <ul>
      <li class="relative px-6 py-3">
        ...
        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
          ...
          <span class="ml-4">Daftar Mahasiswa</span>
        </a>
      </li>
    </ul>
