...
<header id="warna" class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
    ...
    <ul class="flex items-center flex-shrink-2 space-x-6">
      ...
      <li class="relative">
        <button class="align-middle rounded-full focus:shadow-outline-purple focus:outline-none"
          ...
          <img class="object-cover w-8 h-8 rounded-full" src="https://i.ibb.co/bL3jwny/programmer.png"
